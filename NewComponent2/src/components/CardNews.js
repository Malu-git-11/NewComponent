class CardNews extends HTMLElement {
    ...
    build() {
        ...
        newContent.textContent = `Procura-se Devs que saibam trabalhar sobre pressão, para trabalhar no Project Catch the Pigeon. Ambiente acolhedor e amigável, dando enfase no crescimento pessoal. Café por conta da casa.`
